...
exports.getStatusModel = exports.StatusSchema = void 0;
...
let Model;
const getStatusModel = () => __awaiter(void 0, void 0, void 0, function* () {
    const conn = yield (0, mongo_1.getConnectionToDatabase)(constants_1.DATABASE);
    if (conn) {
        if (!Model) {
            console.log('Init new StatusModel ... ');
            Model = yield conn.model('StatusModel', exports.StatusSchema);
        }
        return Model;
    }
